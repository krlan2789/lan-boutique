        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            <div class="sm:col-span-2">
                ...
                <div class="flex flex-col mx-auto mt-6 md:flex-row">
                    <input id="email" type="email" class="input-main" placeholder="example@example.com">

                    <button class="mt-2 ml-1 btn-main">Subscribe</button>
                </div>
            </div>

            <div>
                <p class="text-xl font-normal text-primary dark:text-tertiary">Quick Link</p>
                ...
                <div class="flex flex-col items-start mt-4 space-y-2">
                    ...
                    <a href="#" class="simple-link">Who We Are</a>
                    <a href="#" class="simple-link">Our Philosophy</a>
                </div>
            </div>

            <div>
                <p class="text-xl font-normal text-primary dark:text-tertiary">Industries</p>
                <div class="mt-2 border-b-[2px] border-primary/50"></div>
                <div class="flex flex-col items-start mt-4 space-y-2">
                    <a href="#" class="simple-link">Retail & E-Commerce</a>
                    <a href="#" class="simple-link">Information Technology</a>
                    <a href="#" class="simple-link">Finance & Insurance</a>
                </div>
            </div>
        </div>

        <hr class="my-6 border-quaternary md:my-8 dark:border-primary">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex -mx-2">
                <a href="#"
                    ...
                    <svg role="img" width="100%" class="fill-current size-6" viewBox="0 0 24 24"
