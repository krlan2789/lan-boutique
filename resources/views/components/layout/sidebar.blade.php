...
<aside class="flex">
    <div class="flex flex-col items-center w-16 h-screen py-8 space-y-8 bg-white dark:bg-gray-900 dark:border-gray-700">
        <a href="#">
            <img class="w-auto h-6" src="/img/logo/Logo_only_wb.webp" alt="LAN Technology">
        </a>
            ...
            <button
                ...
                <div class="relative">
                    <img class="object-cover w-8 h-8 rounded-full"
                        ...
                        alt="">
                    <span
                        class="h-2 w-2 rounded-full bg-emerald-500 absolute right-0.5 ring-1 ring-white bottom-0"></span>
                </div>
